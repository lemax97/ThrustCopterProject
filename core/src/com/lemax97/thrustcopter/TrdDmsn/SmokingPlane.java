...
public class SmokingPlane extends BaseScene {
    ...
    public SmokingPlane(ThrustCopter thrustCopter) {
        ...
        // ParticleSystem is a singleton class, we doesn't get the instance instead of creating a new object:
        ...
        game.manager.load("3D/Smoke3D", ParticleEffect.class, loadParam);
        game.manager.finishLoading();

        ParticleEffect originalEffect = game.manager.get("3D/Smoke3D");
    ...
    @Override
    public void dispose() {
        for (ModelInstance mi : instances) mi.model.dispose();
        instances.clear();
        modelBatch.dispose();
    ...
    public void render(float delta) {
        ...
        particleSystem.update(); // techincally not necessary for rendering

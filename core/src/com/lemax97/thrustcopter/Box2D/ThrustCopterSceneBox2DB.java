...
public class ThrustCopterSceneBox2DB extends BaseScene {
	...
	public ThrustCopterSceneBox2DB(ThrustCopter thrustCopter) {
		super(thrustCopter);
		batch=game.batch;
		camera=game.camera;
		atlas=game.atlas;
	...
	private void initPhysics() {
		...
		planeBody=createPhysicsObjectFromGraphics((TextureRegion) plane.getKeyFrame(0),planePosition,BodyType.DynamicBody);
